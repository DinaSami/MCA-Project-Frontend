...
* Project Idea : MCA Project facilitates for patient to book an appointment in a medical clinics and provides a feature to contact the doctors directly for urgent cases.
## URLs
* Heroku applications
